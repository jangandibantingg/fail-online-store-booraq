  ...
  <section id="banner">
    ...
    <div id="banner-monster">
      ...
      <div class="moustache-monster">
        <img src="library/images/moustache-monster.png" alt="monster">
      </div>
      <div id="stars">
...
<div id="advertising-wrap">
  <section id="advertising">
    <div class="ad-box clearfix">
      <a href="#">
        <img src="library/images/banners/banner1.png" alt="banner1">
      </a>
      <a href="#">
        <img src="library/images/banners/banner2.png" alt="banner2">
      </a>
    </div>
    <a href="#">
      <img src="library/images/banners/banner3.png" alt="banner3">
    </a>
  </section>
</div>
<!-- /ADVERTISING -->
  ...
  <section class="product-showcase">
    ...
    <ul id="owl-f-products" class="product-list grid owl-carousel">
            ...
            <div id="qv-p1" class="product-quick-view mfp-with-anim mfp-hide">
              ...
              <div class="product-pictures">
                <div class="product-photo">
                  <figure class="liquid">
                    <img src="library/images/items/02.png" alt="product-image">
                  </figure>
                </div>
                <ul class="picture-views">
                  ...
                  <li class="selected">
                    <figure class="liquid">
                      <img src="library/images/items/02.png" alt="picture-view">
                    </figure>
                  </li>
                  <!-- /VIEW -->
                  ...
                  <li>
                    <figure class="liquid">
                      <img src="library/images/items/01.png" alt="picture-view">
                    </figure>
                  </li>
                  <!-- /VIEW -->
                </ul>
      ...
      <li class="list-item">
        ...
        <div class="actions">
          <figure class="liquid">
            <img src="library/images/items/15.png" alt="product">
          </figure>
          <div>
            ...
            <div id="qv-p2" class="product-quick-view mfp-with-anim mfp-hide">
              ...
              <div class="product-pictures">
                ...
                <ul class="picture-views">
                  ...
                  <li class="selected">
                    <figure class="liquid">
                      <img src="library/images/items/15.png" alt="picture-view">
                    </figure>
                  </li>
                  <!-- /VIEW -->
                </ul>
      ...
      <li class="list-item">
        ...
        <div class="actions">
          <figure class="liquid">
            <img src="library/images/items/35.png" alt="product1">
          </figure>
          <div>
            ...
            <div id="qv-p3" class="product-quick-view mfp-with-anim mfp-hide">
              ...
              <div class="product-pictures">
                <div class="product-photo">
                  <figure class="liquid">
                    <img src="library/images/items/35.png" alt="product-image">
                  </figure>
                </div>
                <ul class="picture-views">
                  <!-- VIEW -->
                  <li class="selected">
                    <figure class="liquid">
                      <img src="library/images/items/35.png" alt="picture-view">
                    </figure>
                  </li>
                  <!-- /VIEW -->
                </ul>
      ...
      <li class="list-item">
        ...
        <div class="actions">
          <figure class="liquid">
            <img src="library/images/items/31.png" alt="product1">
          </figure>
          <div>
            ...
            <div id="qv-p4" class="product-quick-view mfp-with-anim mfp-hide">
              ...
              <div class="product-pictures">
                <div class="product-photo">
                  <figure class="liquid">
                    <img src="library/images/items/31.png" alt="product-image">
                  </figure>
                </div>
                <ul class="picture-views">
                  <!-- VIEW -->
                  <li class="selected">
                    <figure class="liquid">
                      <img src="library/images/items/31.png" alt="picture-view">
                    </figure>
                  </li>
                  <!-- /VIEW -->
                </ul>
      ...
      <li class="list-item">
        ...
        <div class="actions">
          <figure class="liquid">
            <img src="library/images/items/09.png" alt="product1">
          </figure>
          <div>
            ...
            <div id="qv-p5" class="product-quick-view mfp-with-anim mfp-hide">
              ...
              <div class="product-pictures">
                <div class="product-photo">
                  <figure class="liquid">
                    <img src="library/images/items/09.png" alt="product-image">
                  </figure>
                </div>
                <ul class="picture-views">
                  <!-- VIEW -->
                  <li class="selected">
                    <figure class="liquid">
                      <img src="library/images/items/09.png" alt="picture-view">
                    </figure>
                  </li>
                  <!-- /VIEW -->
                </ul>
      ...
      <li class="list-item">
        ...
        <div class="actions">
          <figure class="liquid">
            <img src="library/images/items/39.png" alt="product1">
          </figure>
          <div>
            ...
            <div id="qv-p6" class="product-quick-view mfp-with-anim mfp-hide">
              ...
              <div class="product-pictures">
                <div class="product-photo">
                  <figure class="liquid">
                    <img src="library/images/items/39.png" alt="product-image">
                  </figure>
                </div>
                <ul class="picture-views">
                  <!-- VIEW -->
                  <li class="selected">
                    <figure class="liquid">
                      <img src="library/images/items/39.png" alt="picture-view">
                    </figure>
                  </li>
                  <!-- /VIEW -->
                </ul>
  ...
  <section class="product-showcase">
    ...
    <ul id="owl-bs-products" class="product-list grid owl-carousel">
          ...
          <div>
            ...
            <div id="qv-p7" class="product-quick-view mfp-with-anim mfp-hide">
              ...
              <div class="product-pictures">
                <div class="product-photo">
                  <figure class="liquid">
                    <img src="library/images/items/33.png" alt="product-image">
                  </figure>
                </div>
                <ul class="picture-views">
                  <!-- VIEW -->
                  <li class="selected">
                    <figure class="liquid">
                      <img src="library/images/items/33.png" alt="picture-view">
                    </figure>
                  </li>
                  <!-- /VIEW -->
                </ul>
      ...
      <li class="list-item">
        ...
        <div class="actions">
          <figure class="liquid">
            <img src="library/images/items/25.png" alt="product1">
          </figure>
          <div>
            ...
            <div id="qv-p8" class="product-quick-view mfp-with-anim mfp-hide">
              ...
              <div class="product-pictures">
                <div class="product-photo">
                  <figure class="liquid">
                    <img src="library/images/items/25.png" alt="product-image">
                  </figure>
                </div>
                <ul class="picture-views">
                  <!-- VIEW -->
                  <li class="selected">
                    <figure class="liquid">
                      <img src="library/images/items/25.png" alt="picture-view">
                    </figure>
                  </li>
                  <!-- /VIEW -->
                </ul>
      ...
      <li class="list-item">
        ...
        <div class="actions">
          <figure class="liquid">
            <img src="library/images/items/04.png" alt="product1">
          </figure>
          <div>
            ...
            <div id="qv-p9" class="product-quick-view mfp-with-anim mfp-hide">
              ...
              <div class="product-pictures">
                <div class="product-photo">
                  <figure class="liquid">
                    <img src="library/images/items/04.png" alt="product-image">
                  </figure>
                </div>
                <ul class="picture-views">
                  <!-- VIEW -->
                  <li class="selected">
                    <figure class="liquid">
                      <img src="library/images/items/04.png" alt="picture-view">
                    </figure>
                  </li>
                  <!-- /VIEW -->
                </ul>
      ...
      <li class="list-item">
        ...
        <div class="actions">
          <figure class="liquid">
            <img src="library/images/items/07.png" alt="product1">
          </figure>
          <div>
            ...
            <div id="qv-p10" class="product-quick-view mfp-with-anim mfp-hide">
              ...
              <div class="product-pictures">
                <div class="product-photo">
                  <figure class="liquid">
                    <img src="library/images/items/07.png" alt="product-image">
                  </figure>
                </div>
                <ul class="picture-views">
                  <!-- VIEW -->
                  <li class="selected">
                    <figure class="liquid">
                      <img src="library/images/items/07.png" alt="picture-view">
                    </figure>
                  </li>
                  <!-- /VIEW -->
                </ul>
      ...
      <li class="list-item">
        ...
        <div class="actions">
          <figure class="liquid">
            <img src="library/images/items/37.png" alt="product1">
          </figure>
          <div>
            ...
            <div id="qv-p11" class="product-quick-view mfp-with-anim mfp-hide">
              ...
              <div class="product-pictures">
                <div class="product-photo">
                  <figure class="liquid">
                    <img src="library/images/items/37.png" alt="product-image">
                  </figure>
                </div>
                <ul class="picture-views">
                  <!-- VIEW -->
                  <li class="selected">
                    <figure class="liquid">
                      <img src="library/images/items/37.png" alt="picture-view">
                    </figure>
                  </li>
                  <!-- /VIEW -->
                </ul>
      ...
      <li class="list-item">
        ...
        <div class="actions">
          <figure class="liquid">
            <img src="library/images/items/34.png" alt="product1">
          </figure>
          <div>
            ...
            <div id="qv-p12" class="product-quick-view mfp-with-anim mfp-hide">
              ...
              <div class="product-pictures">
                <div class="product-photo">
                  <figure class="liquid">
                    <img src="library/images/items/34.png" alt="product-image">
                  </figure>
                </div>
                <ul class="picture-views">
                  <!-- VIEW -->
                  <li class="selected">
                    <figure class="liquid">
                      <img src="library/images/items/34.png" alt="picture-view">
                    </figure>
                  </li>
                  <!-- /VIEW -->
                </ul>
    ...
    <div class="slidable">
      ...
      <ul id="owl-blog-posts" class="blog-post-preview grid owl-carousel">
        ...
        <li class="list-item">
          <a href="post.html">
            <figure>
              <img src="library/images/blog/post1.jpg" alt="post1">
            </figure>
          </a>
          <div class="content">
        ...
        <li class="list-item">
          <a href="post.html">
            <figure>
              <img src="library/images/blog/post2.jpg" alt="post2">
            </figure>
          </a>
          <div class="content">
        ...
        <li class="list-item">
          <a href="post.html">
            <figure>
              <img src="library/images/blog/post3.jpg" alt="post3">
            </figure>
          </a>
          <div class="content">
        ...
        <li class="list-item">
          <a href="post.html">
            <figure>
              <img src="library/images/blog/post4.jpg" alt="post4">
            </figure>
          </a>
          <div class="content">
...
<div id="billboard-wrap">
  <section id="billboard">
    ...
    <div class="sale-promo">
      ...
      <img src="library/images/bunny-monster.png" alt="bunny-monster">
      <div id="bubbles">
  ...
  <section id="brands">
    ...
    <div class="slidable">
      ...
      <ul id="owl-brands" class="brands-list owl-carousel">
        ...
        <li>
          <a href="#">
            <img src="library/images/brands/gr.png" alt="brand-normal">
            <img src="library/images/brands/gr-over.png" alt="brand-over">
          </a>
        </li>
        <!-- /BRAND -->
        ...
        <li>
          <a href="#">
            <img src="library/images/brands/tf.png" alt="brand-normal">
            <img src="library/images/brands/tf-over.png" alt="brand-over">
          </a>
        </li>
        <!-- /BRAND -->
        ...
        <li>
          <a href="#">
            <img src="library/images/brands/aj.png" alt="brand-normal">
            <img src="library/images/brands/aj-over.png" alt="brand-over">
          </a>
        </li>
        <!-- /BRAND -->
        ...
        <li>
          <a href="#">
            <img src="library/images/brands/vh.png" alt="brand-normal">
            <img src="library/images/brands/vh-over.png" alt="brand-over">
          </a>
        </li>
        <!-- /BRAND -->
        ...
        <li>
          <a href="#">
            <img src="library/images/brands/pd.png" alt="brand-normal">
            <img src="library/images/brands/pd-over.png" alt="brand-over">
          </a>
        </li>
        <!-- /BRAND -->
