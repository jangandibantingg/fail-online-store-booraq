...
$a=mysqli_query($con, "select * from order_produk where id_produk='$id_produk' and email='$_SESSION[user_session]'  ");
if ( empty($_SESSION['user_session']) ) {
?>
<script type="text/javascript">
  $('.info').notify("anda belum login", "success");
</script>
...
<?php
  ...
  $a=mysqli_query($con, "insert into order_produk (id_produk, email, qty, harga, tanggal, jam, courier, service, weight, ongkir, destination, origin) values ('$id_produk','$_SESSION[user_session]','$qty','$harga','$date','$jam','$espedisi','$service','$weight','$ongkir','$destination','$origin[city_id]')");
  echo "<script type='text/javascript'>
